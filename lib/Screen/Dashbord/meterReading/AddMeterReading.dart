...
import 'Bloc/addmeterReading/addmeter_reading_bloc.dart';
...
class _AddMeterReadingScreenState extends State<AddMeterReadingScreen> {
  ...
  late AddmeterReadingBloc _readingBloc;

  @override
  void initState() {
    super.initState();
    _readingBloc = AddmeterReadingBloc();
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          BlocListener<AddmeterReadingBloc, AddmeterReadingState>(
            bloc: _readingBloc,
            listener: (context, state) {
              if (state is AddmeterReadingLoading) {
                showDialog(
                  context: context,
                  barrierDismissible: false,
                  builder: (_) => const Center(child: CircularProgressIndicator()),
                );
              } else if (state is AddmeterReadingSuccess) {
              ...
              } else if (state is AddmeterReadingFailure) {
              ...
              } else if (state is AddmeterReadingNoInternet) {
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      // Submit to bloc
                      _readingBloc.add(SubmitMeterReadingEvent(
                        userId: userId,
